...
public final class TemplateCompiler {
    ...
    public String compile(String templateBody, Map<String, String> values) {
        return compile(templateBody, values, false);
    }

    public String compile(String templateBody, Map<String, String> values, boolean quoteValues) {
        ...
        while (m.find()) {
            ...
            String normalized = InputText.trimToEmpty(raw);
            String replacement = quoteValues ? quoteEnclosedValue(normalized) : normalized;
